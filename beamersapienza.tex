...
\begin{frame}{竞赛推荐 (一)：算法 · 逻辑}
    \begin{columns}[T]
        ...
        \begin{column}{0.33\textwidth}
            ...
            \end{center}
            \begin{itemize}
                \item \textbf{ / PAT / 天梯赛 $\star \star \star \star$}: \small \alert{参与门槛低，获奖面广}，适合作为简历上的第一份荣誉。
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{如何对待竞赛：初心与“内卷”}
    % \begin{block}{竞赛的初心：我们为何出发？}
    %     \begin{itemize}
    %         \item \textbf{检验真知}: 将课本上的抽象理论，转化为解决实际问题的具体能力。
    %         \item \textbf{挑战自我}: 在与顶尖同龄人的切磋中，发现不足，突破认知与能力的边界。
    %         \item \textbf{收获荣誉}: 凭借自身的汗水与智慧，赢得那份独一无二的成就感与认可。
    %         \item \textbf{团队协作}: 学会沟通、分工与信任，体验 $1+1>2$ 的化学反应。
    %     \end{itemize}
    % \end{block}

    % \vfill

    \begin{alertblock}{当竞赛“变了味”：警惕这些异化现象}
        当评价体系过度量化，初心就可能被遗忘：
        \begin{itemize}
            \item \textbf{奖项 > 能力}: 参赛不再是为了热爱与学习，而仅仅是为了\alert{奖学金、保研加分、简历镀金}。获奖成了唯一目标，过程中的学习与成长被忽略。
            
            \item \textbf{购买“硬通货”}: 为什么一堆人拼命买软著、专利？因为在许多量化评审中，它们是“创新能力”的直接证明。这导致\alert{创新过程被异化为一纸证书交易}，而非真正的技术创造。
            
            \item \textbf{包装“伪成果”}: 为什么要买“水刊”论文？因为它们能以低成本、高速度的方式，为简历包装出看似亮眼的“科研经历”，利用了\alert{外行评审对学术质量的认知盲区}。
        \end{itemize}
    \end{alertblock}
...
\begin{frame}{最后的最后：一份“活”的指南，一个开源的传承}
     \framesubtitle{世界是属于开源的}
    \vfill
    \begin{center}
        \large
        \textit{时代在变换，技术在迭代...} \\
        \textit{今天我们所讨论的一切，或许在几年后就会成为历史。} \\
        \vspace{0.3cm}
        \textit{所以，这份指南本身，也需要不断地进化。}
    \end{center}
    ...
    \begin{center}
        ...
        \huge
        \hrefcol{https://github.com/Naasi-LF/CZU_CS_GUIDE}{\texttt{Naasi-LF/CZU\_CS\_GUIDE}}
        
        \vspace{0.5cm}
        \large
        \textbf{欢迎未来的你，为它贡献一份属于你的力量！} \\
        \large
        \textbf{(Star, Fork, Pull Request)}
    \end{center}
    \vfill
\end{frame}
